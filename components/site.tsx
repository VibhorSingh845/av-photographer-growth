...
export function Footer() { return <footer><div className="shell footer-inner"><Link className="brand" href="/"><span>AV</span><i />Photographer Growth</Link><div><a href="mailto:hello@youragency.com">hello@youragency.com</a><a href="#">Instagram</a><a href="#">Privacy</a></div><p>© {new Date().getFullYear()} AV / Photographer Growth</p></div></footer>; }
